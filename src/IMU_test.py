...
try:
    with open('./data/IMUdata.csv', 'w') as outfile:
        ...
        while True:            
            ...
            ## saving data to csv
            outfileWrite.writerow([timer, acc_x, acc_y, acc_z, gyro_x, gyro_y, gyro_z,temp, roll_deg, pitch_deg, yaw_deg])
            #
            ...
            print("roll angle [deg] =", roll_deg)
            print("pitch angle [deg] =", pitch_deg)
            print("yaw angle [deg] =", yaw_deg)
